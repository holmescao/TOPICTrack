...
class TAO(_BaseDataset):
    ...
    def __init__(self, config=None):
        ...
        considered_vid_ids = [self.seq_name_to_seq_id[vid]
                              for vid in self.seq_list]
        seen_cats = set(
            [
                cat_id
        ...
        for tracker in self.tracker_list:
            tr_dir_files = [
                ...
                for file in os.listdir(
                    os.path.join(self.tracker_fol, tracker,
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        all_classes = [self.class_name_to_class_id[cls]
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        if data["dt_tracks"]:
            ...
            data["dt_track_lengths"] = [data["dt_track_lengths"][i]
                                        for i in idx]
    ...
    def _compute_image_to_timestep_mappings(self):
        ...
        seq_to_imgs_to_timestep = {vid["id"]: dict()
                                   for vid in self.gt_data["videos"]}
